	...
	<div class="container2">	
		<form action="" method="GET">
			<select name="country" id="">
				<option value="England" <?php if($option=='England') echo 'selected'; ?> >England</option>
				<option value="France" <?php if($option=='France') echo 'selected'; ?> >France</option>
				<option value="Germany" <?php if($option=='Germany') echo 'selected'; ?> >Germany</option>
			</select>
